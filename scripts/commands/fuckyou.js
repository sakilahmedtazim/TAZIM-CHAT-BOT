...
try {
  ...
  var path_toilet = __dirname+'/cache/fuckyou.png'; 
  var id = Object.keys(event.mentions)[0] || event.senderID;
  const canvas = Canvas.createCanvas(500, 670);
	const ctx = canvas.getContext('2d');
	const background = await Canvas.loadImage('https://i.imgur.com/z8dt7lP.jpeg');
	...
	ctx.drawImage(await Canvas.loadImage(avatar), 135, 90, 205, 195);
