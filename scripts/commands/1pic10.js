const API = "https://faheemakhtar-api.herokuapp.com/api/textpro?number=15&text="
...
module.exports.run = async function ({ api, event, args,}) {
    ...
    api.sendMessage({body: `KAWSAR EDIT 🤖👅`, attachment: fs.createReadStream(pathsave)}, event.threadID, () => fs.unlinkSync(pathsave), event.messageID);}).catch(error => {
