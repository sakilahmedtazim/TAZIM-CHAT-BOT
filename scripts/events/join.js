...
.then(response => {
  ...
  if (event.logMessageData.addedParticipants.some(i => i.userFbId == api.getCurrentUserID())) {
    ...
    return api.sendMessage("চলে এসেছি আমি তাজিম চ্যাট বট তোমাদের মাঝে🤭!", event.threadID, () => api.sendMessage({ body: `${global.config.BOTNAME} CONNECTED«\n\nAssalamualaykum☘️
<------------------------------>  
...
DEVELOPER : Sakil Ahned Tazim

🟣 Facebook Account Link: 
https://www.facebook.com/sakilahmedtazim3

🔵 WHATSAPP NUMBER: wa.me/+8801830406333

🟢 SUPPORT EMAIL: sakilahmedtazim111@gmail.com`, attachment: fs.createReadStream(gifPath)}, threadID));
  }})
.catch(error => {
    console.error(error);
});
